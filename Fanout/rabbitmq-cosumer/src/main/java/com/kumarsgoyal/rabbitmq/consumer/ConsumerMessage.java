...
public class ConsumerMessage {
    ...
    private static final String HR_QUEUE_NAME = "queue.picture.hr.queue";
    private static final String ACCOUNTS_QUEUE_NAME = "queue.picture.accounts.queue";
    private static final String IT_QUEUE_NAME = "queue.picture.it.queue";
